...
public class BalanceCommand extends QueryBuilderBalance {
	...
	public Balance getBalance(String account) throws MultichainException {
		Balance balance = new Balance();
		Object objectGetBalance = executeGetBalance(account);
		if (verifyInstance(objectGetBalance, Double.class)) {
			balance.setAmount((Double) objectGetBalance);
		}
		return balance;
	}
